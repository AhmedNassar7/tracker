...
| `load_extra_job_boards` | `tests/test_public_sources.py` | YAML-by-hand parsing of `ashby:`/`smartrecruiters:`/`pinpoint:` sections (bare token → `<token>.pinpointhq.com`; dotted token kept as-is) |
