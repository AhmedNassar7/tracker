...
const STEPS: Step[] = [
  {
    ...
    body: "Refreshes hourly, straight from the pipeline. Always current.",
  },
  {
    target: "filters",
    icon: FilterIcon,
    title: "Filter it down",
    body: "Filter by company, region, level, and role. Save a combination as your default view.",
  },
  {
    target: "sort-mode",
    icon: SortIcon,
    title: "Choose how it's ranked",
    body: "Top companies, Newest, or Best match — ranked against your profile.",
  },
  {
    target: "job-row",
    icon: TargetIcon,
    title: "Every link is the real posting",
    body: "Goes straight to the company's apply page, never a reposting. Dead links get flagged automatically.",
  },
  {
    target: "workspace-nav",
    icon: UserIcon,
    title: "Your workspace",
    body: "Set up a profile for match scores, track applications, or check your résumé.",
  },
  {
    target: "rss-feeds",
    icon: RssIcon,
    title: "Prefer RSS to email?",
    body: "Subscribe to a feed and get new postings in your reader.",
  },
];
