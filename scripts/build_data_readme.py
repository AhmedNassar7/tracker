...
COMMUNITY_TRACKER_SOURCES = frozenset({
    ...
    "lorenzolacorte_eu", "hanzili_canada", "negarprh_canada_internships",
    "ambicuity", "derec4_newgrad", "lamiiine_visa",
})
...
def render_root_readme(now_text: str, stats: dict) -> str:
    ...
    status_badges = " ".join([
        ...
        "[![CI](https://github.com/AhmedNassar7/tracker/actions/workflows/ci.yml/badge.svg)](https://github.com/AhmedNassar7/tracker/actions/workflows/ci.yml)",
        "[![Deploy site](https://github.com/AhmedNassar7/tracker/actions/workflows/deploy-site.yml/badge.svg)](https://github.com/AhmedNassar7/tracker/actions/workflows/deploy-site.yml)",
    ...
    stack_badges = " ".join([
        "[![Python 3.11+](https://img.shields.io/badge/Python-3.11%2B-3776AB.svg?logo=python&logoColor=white)](scripts/)",
        "[![stdlib only](https://img.shields.io/badge/dependencies-stdlib%20only-informational.svg)](CLAUDE.md)",
        "[![Astro site](https://img.shields.io/badge/site-Astro%20%2B%20React-ff5d01.svg?logo=astro&logoColor=white)](site/)",
    ])
    ...
    return "\n".join([
        ...
        "",
        "The site's brand color, light/dark: "
        "[![0f766e](https://img.shields.io/badge/light-0f766e-0f766e.svg)](site/src/styles/global.css) "
        "[![2dd4bf](https://img.shields.io/badge/dark-2dd4bf-2dd4bf.svg)](site/src/styles/global.css) "
        '<img src="assets/bookmark-pop.svg" width="20" height="20" valign="middle" alt="Bookmark pop micro-interaction preview"> '
        "— every real animation in [docs/FEATURES.md#design-system--motion](docs/FEATURES.md#design-system--motion).",
        "",
        "Live site: **https://ahmednassar7.github.io/tracker/** — architecture, setup, and deployment details are in "
